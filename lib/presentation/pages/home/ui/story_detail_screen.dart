    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ListView(padding:const EdgeInsets.all(5),
            children: [
              travelStory.photos.isNotEmpty
                  ...
                  : Container(),
              Text(travelStory.photos.length.toString(),textAlign: TextAlign.end,),
              Container(
                  decoration: BoxDecoration(borderRadius:const BorderRadius.all(Radius.circular(10)),color: Colors.grey.shade300),
                child: Column(
                  children: [
                    Container(
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: TextContainer(text: travelStory.travelStory,selectableText: true,fontSize: 16,),
                ),
                  ],
                ),
              ),
          ...
          Positioned(
            bottom: 0,left: MediaQuery.of(context).size.width * 0.025,right: MediaQuery.of(context).size.width * 0.025,
            child: Container(
