                      ...
                      children: [
                        Stack(
                          children: [
                            ...
                            if (randomuser!.profileurl! != null ||
                                randomuser!.profileurl!.isNotEmpty)
                              Container(
                                height: 130,
                                width: 130,
                                decoration: BoxDecoration(
                                    boxShadow: [
                                      BoxShadow(
                                          color: Colors.grey, blurRadius: 12)
                                    ],
                            ...
                            child: StreamBuilder<QuerySnapshot>(
                                ...
                                builder: (context,
                                  ...
                                  return TextButton(
                                      ...
                                      child: Text(
                                          randomuser!.followers.contains(owner)
                                              ? 'Unfollow'
                                              : 'Follow'));
                                }),
                          )
